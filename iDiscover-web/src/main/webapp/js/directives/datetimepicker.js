      ...
      return {
        ...
        template: function(elem, attrs) {
          ...
          var tmpl = "<div class=\"datetimepicker-wrapper\">" +
            "<input class=\"form-control\" type=\"text\" ng-model=\"dateTime\" ng-change=\"dateTime_change()\" " + [
              ["min", "minDate"],
              ["max", "maxDate"],
              ["dayFormat"],
              ["monthFormat"],
            ...
            "/>\n" +
            "</div>\n" +
            "<div class=\"datetimepicker-wrapper\" ng-model=\"dateTime\" ng-show=\"dateTime\" ng-change=\"dateTime_change()\">\n" +
            "<timepicker " + [
              ["hourStep"],
              ["minuteStep"],
              ["showMeridian"],
        ...
        controller: ['$scope', '$interval',
          function($scope, $interval) {
            $scope.dateTime_change = function() {
              if (angular.isDefined($scope.ngModel) && angular.isDefined($scope.dateTime)) {
            	  $interval(function() {
            		  $scope.ngModel = $scope.dateTime;
            	  }, 4000, 1);
              }
            }
          }
